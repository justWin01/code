...
public class sherwinquiz2 extends JFrame {
    ...
    public sherwinquiz2() {
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                float fresult = (float) number1 / number2;
                tfResult.setText(String.valueOf(fresult));
            }
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new sherwinquiz2(); // Let the constructor does the job
            }
        });
    }
}
